  ...
  function(dialogs, $http) {
    ...
    var notifications = {
      '1.1.6': [
        ...
        '<li>SearchEngines: (fix) limetorrrents DL links and new domain, 1337x DL links, TPB (*0.org), TPB mirror resolver proxybay.unblockit.black, torrentdownloads new domain, fix details link for Jackett indexers.',
